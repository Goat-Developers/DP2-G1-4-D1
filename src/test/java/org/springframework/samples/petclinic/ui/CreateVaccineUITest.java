...
@DirtiesContext
public class CreateVaccineUITest {
  ...
  @Test
	public void testCreateVaccine() throws Exception {
		...
		.thenICanCreateAVaccine();
	}
	
	private void thenICanCreateAVaccine() {
		 assertEquals("Vaccine1", driver.findElement(By.xpath("//table[@id='vaccineTable']/tbody/tr[11]/td")).getText());
	}
	
	private CreateVaccineUITest whenIamLoggedIntheSystem() {	
		return this;
	}

	private CreateVaccineUITest as(String username) {
    ...
    driver.findElement(By.id("name")).sendKeys("Vaccine1");
    driver.findElement(By.id("information")).click();
    driver.findElement(By.id("information")).clear();
    driver.findElement(By.id("information")).sendKeys("vaccine1");
    ...
    driver.findElement(By.id("sideEffects")).sendKeys("vaccine1");

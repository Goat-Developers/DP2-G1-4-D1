...
@DirtiesContext
public class ManageAnnouncementUITest {
	...
	private void thenICanGetFeedbackAnAnnouncement() {
		assertEquals("caballos", driver.findElement(By.xpath("//table[@id='announcementsTable']/tbody/tr/td[3]")).getText());
	}
		
	private ManageAnnouncementUITest whenIamLoggedIntheSystem() {	
		return this;
	}
		
	private ManageAnnouncementUITest as(String username) {
		...
		driver.findElement(By.name("tag")).sendKeys("caballos");
